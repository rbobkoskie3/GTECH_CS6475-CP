...
class Assignment2Test(unittest.TestCase):
    def setUp(self):
        self.testImage = cv2.imread("ANYA.jpg", cv2.IMREAD_GRAYSCALE)
        self.testImage2 = cv2.imread("ROB.jpg", cv2.IMREAD_GRAYSCALE)
    ...
    def test_flipHorizontal(self):
        self.assertEqual(type(flipHorizontal(self.testImage2)),
                         type(self.testImage2))
